...
<!--        <input type="text" name="query" placeholder="Enter address"/>-->
...
<!--    </form>-->
    ...
    $sql = "SELECT id, address,price, contact, details FROM rooms";
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text "><span style="color:blue">Rs.</span><?php echo $record['price']; ?> </p>
