            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <ul class="navbar-nav ml-auto">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                        ...
                        <!-- Search form -->
                        <form class="form-inline ml-auto" action="searchHouse1.php" method="GET">
...
<div class="container mt-5 pt-5 heading-section  ftco-animate">
    <span class="subheading ml-5 mt-3">Search Results for Building </span>
    <?php
    include_once("login/dbconn.php");
    $sql = "SELECT id, username, address,price, contact, details FROM house";
    ...
    <a href="addHouse.php"><h4> <span class="badge badge-secondary m-5">Add Building</span></h4></a>
