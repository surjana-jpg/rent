            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <ul class="navbar-nav ml-auto">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                        ...
                        <!-- Search form -->
                        <form class="form-inline ml-auto" action="searchApt1.php" method="GET">
...
<div class="container mt-5 pt-5 heading-section  ftco-animate">
    <span class="subheading ml-5 mt-3">Search Results for Apartments</span>
    <?php
    include_once("login/dbconn.php");
    $sql = "SELECT id, username, address,price, contact, details FROM apt";
        ...
        <div class="card border-dark m-3" style="max-width: 1100px;">
            <div class="row no-gutters">
                <div class="col-md-4">
                    ...
                    $query = $conn->query("SELECT file_name FROM apt where id = '$record[id]' " );
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title">APT<?php echo $record['id']; ?></h5>
    ...
    <a href="addApt.php"><h4> <span class="badge badge-secondary m-5">Add Apartments</span></h4></a>
