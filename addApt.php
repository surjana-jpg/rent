        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item"><a href="room1.php" class="nav-link">Room</a></li>
...
<div class="container mt-5 pt-5 heading-section  ftco-animate">
    ...
    <div class="col-9 " >
        <form action="insertApt.php" method="post" enctype="multipart/form-data"  >

            Address : <input type="text" class="form-control" name = "address" required>
            Price per month: <input type="number" class="form-control" name="price" required>
