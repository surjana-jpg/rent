...
<div class="container mt-5 pt-5 heading-section  ftco-animate">
    <span class="subheading ml-5 mt-3">Click to add</span>
    <ul class="list-group m-5" style="width: 200px">
        <a href="addRoom.php"><li class="list-group-item list-group-item-success ">Rooms</li></a>
        <br>
        <a href="addApt.php"><li class="list-group-item list-group-item-success">Apartments</li></a>
        <br>
        <a href="addHouse.php"><li class="list-group-item list-group-item-success">Bulidings</li></a>
