...
<div class="container mt-5 pt-5 heading-section  ftco-animate">
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($conn,"SELECT * FROM apt
                ...
                <div class="card border-dark m-3" style="max-width: 1100px;">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            ...
                            $query = $conn->query("SELECT file_name FROM apt where id = '$results[id]' " );
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title ">APT<?php echo $results['id']; ?></h5>
